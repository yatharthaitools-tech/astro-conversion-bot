...
TRIGGER_RECOMMEND_ASTROLOGER = {
    ...
    "description": (
        ...
        "next_available_at (present only in this case). State it "
        "plainly in one go: their status/ETA directly ('Nidhi's offline, "
        "back in about 40 minutes'), then that you're connecting with "
        "someone available now instead — never claim the shown card "
        "will reach the person you named if it won't. You can still "
