...
def _build_system_prompt(packages, astrologers, quick_replies, lang: str) -> str:
    ...
    return (
        ...
        "- In almost every reply about a real concern (love/career/marriage/finance/kundali/"
        "general guidance), name one specific astrologer from the data below who fits and "
        "end by inviting the visitor to connect with them now — don't just explain, always "
        "point at a next step.\n"
